...
data class KotlinMetaNode(
        val packageFullName: String,
        val classes: Set<KotlinMetaClass>,
        val children: Map<String, KotlinMetaNode>,
        val packageShortName: String = packageFullName.substringAfterLast(DOT),
)

private class KotlinMetaPackagesTree(classes: Sequence<KotlinMetaClass>) {
    ...
    private inner class Node(val packageFullName: String) {
        private val classes = mutableSetOf<KotlinMetaClass>()
        private val children = mutableMapOf<String, Node>()

        fun add(childClass: KotlinMetaClass) {
        ...
        fun collect(): KotlinMetaNode = KotlinMetaNode(
                packageFullName,
                classes,
...
fun Sequence<KotlinMetaClass>.asTree(): Map<String, KotlinMetaNode> = KotlinMetaPackagesTree(this).collect()

...
val KOTLIN_MAP_META_METHOD_FUNCTION_TYPE_NAME = bestGuess(MutableMap::class.qualifiedName!!).parameterizedBy(
        bestGuess(MetaMethod::class.java.name).parameterizedBy(KOTLIN_META_CLASS_CLASS_NAME.parameterizedBy(ANY.copy(nullable = true)), producerOf(ANY.copy(nullable = true))),

...
val KOTLIN_META_MODULE_CLASS_NAME = bestGuess(MetaModule::class.java.name)
val KOTLIN_META_MODULE_ARRAY_CLASS_NAME = ARRAY.parameterizedBy(KOTLIN_META_MODULE_CLASS_NAME)

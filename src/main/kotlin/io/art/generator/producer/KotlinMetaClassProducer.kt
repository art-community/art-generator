    ...
    metaClass.constructors
            ...
            .mapIndexed { index, constructor ->
                ...
                TypeSpec.classBuilder(name)
                        ...
                        .build()
                        .apply(::addType)
                val constructorClassName = ClassName(EMPTY_STRING, name)
                PropertySpec.builder(name, constructorClassName)
                        .addModifiers(PRIVATE, FINAL)
                        .initializer(kotlinRegisterNewStatement(constructorClassName))
                        .build()
                        .apply(::addProperty)
...
private fun TypeSpec.Builder.generateParameters(method: KotlinMetaMethod) {
    ...
    method.parameters.entries.forEachIndexed { parameterIndex, parameter ->
        ...
        PropertySpec.builder(parameterName, metaParameterType)
                .addModifiers(PRIVATE, FINAL)
                .initializer(kotlinRegisterMetaParameterStatement(parameterIndex, parameter.key, parameter.value.excludeVariables(variableExclusions)))
                .build()
                .apply(::addProperty)

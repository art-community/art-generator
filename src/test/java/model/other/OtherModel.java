...
public class OtherModel<V1, V2 extends String, V3 extends Number & Comparator<V1>, V4 extends V2> extends JavaModel<V1, V2, V3, V4> {
    public OtherModel(String parent, boolean f1, String f2, V1 f3, V2 f4, V3 f5, List<String> f6, List<V1> f7, List<?> f8, List<? extends String> f9, List<? super String> f10, List<? extends V1> f11, List<? super V2> f12, List<? extends V2> f13, List<? super V3> f14, List<? extends V3> f15, List<? super V4> f16, List<? extends V4> f17, boolean[] f18, V1[] f19, V2[] f20, V3[] f21, List<String>[] f22, List<?>[] f23, List<V1>[] f24, List<? extends String>[] f25, List<? super String>[] f26, boolean[][] f27, V1[][] f28, List<String>[][] f29, List<?>[][] f30, List<V1>[][] f31, List<? extends String>[][] f32, List<? super String>[][] f33, List<boolean[]> f34, List<V1[]> f35, List<String[]>[] f36, List<V1[]>[] f37, List<? extends String[]>[] f38, List<? super String[]>[] f39, List<List<Boolean>> f40, List<V1> f41, List<List<String>> f42, List<List<?>> f43, List<List<V1>> f44, List<List<? extends String>> f45, List<List<? super String>> f46, List<List<boolean[]>> f47, List<List<V1[]>> f48, List<List<String[]>> f49, List<List<? extends String[]>> f50, List<List<? super String[]>> f51, JavaModel.InnerModel<String> f52, JavaModel.InnerModel<V1> f53, JavaModel.InnerModel<? extends String> f54, JavaModel.InnerModel<? super String> f55, List<JavaModel.InnerModel<String>> f56, List<? extends List<? extends V1[]>> f57, List<? extends List<? extends V1[]>[]> f58, List<? extends List<? extends V1[]>[]>[] f59, JavaModel<String, V2, JavaModel.IntersectionType, V4> f60, Map<String, String> f61, Map<?, String> f62, Map<String, ?> f63, Map<? super String, ? extends String> f64, Map<? super V1, ? extends V1> f65, Map<V1, V1> f66, Object f67, JavaModel.Enum f68, List<JavaModel.Enum> f69, JavaModel.Enum[] f70, Map<JavaModel.Enum, JavaModel.Enum> f71, Map<JavaModel.Enum, List<JavaModel.Enum>> f72, Map<JavaModel.Enum, List<JavaModel.Enum[]>> f73, Map<JavaModel.Enum, List<? extends JavaModel.Enum[]>> f74, boolean f110) {

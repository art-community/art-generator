...
import io.art.core.constants.CompilerSuppressingWarnings.UNUSED
import io.art.core.constants.CompilerSuppressingWarnings.WARNINGS
import java.time.Duration


// Must be ignored
const val mixedOutsideProperty = "test"

// Must be ignored
fun mixedOutsideMethod(argument: Int) {

}

// Must be ignored
private class MixedPrivateClass {}

// Must be ignored
internal class MixedInternalClass {}

class MixedEmptyClass {}

object MixedEmptyObject {}
...
interface MixedKotlinInterface {
